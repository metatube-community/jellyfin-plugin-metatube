...
def generate(filename, version):
    return {
        ...
        'targetAbi': '10.8.0.0',
        'sourceUrl': 'https://github.com/XGFan/jellyfin-plugin-metatube/releases/download/'
...
def main():
    ...
    with urlopen('https://raw.githubusercontent.com/XGFan/jellyfin-plugin-metatube/dist/manifest.json') as f:
